...
class AppTheme {
  static final _core = AppCoreTheme(
    shadowSub: const Color.fromARGB(255, 17, 0, 255).withAlpha(100),
    primary: const Color.fromARGB(255, 17, 0, 255),
    primaryLight: const Color.fromARGB(255, 17, 0, 255).withAlpha(100),
    textSub: const Color(0xff141414),
    textSub2: const Color(0xff696969),
  );

  static AppCoreTheme light = _core.copyWith(
    background: const Color.fromARGB(255, 36, 35, 35),
